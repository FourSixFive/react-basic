...
app.use('/openapi/getdata', function (req, res) { //이벤트 발생 시 자동 실행되는 함수인 콜백 함수가 실행된다.
    ...
    var queryParams = '?' + encodeURIComponent('serviceKey') + '=MEwBa0%2BrTUyy6leAR7iXyGsVqRaHmvOQbctapGCKbnDwh45gItxmOvWnypcCT7mcK6FWVi90gAjZLZWQmjJQFQ%3D%3D'; /* Service Key*/
